        ...
        <div className="mx-auto max-w-lg text-center">
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:justify-center">
            <button
              type="button"
              onClick={() => reset()}
              className="min-h-tap rounded-lg bg-[#1D9E75] px-6 py-3 font-semibold text-white"
            >
              Yritä uudelleen
            </button>
            <a
              href="/fi"
              className="min-h-tap inline-flex items-center justify-center rounded-lg border border-neutral-300 px-6 py-3 font-semibold"
            >
              Etusivu (FI)
            </a>
            <a
