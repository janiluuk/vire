...
16. **Before opening a pull request**, run **`npm run ci`** (or **`npm run ci:fast`** for lint + unit only). GitHub Actions runs the same **`scripts/ci-local.sh`** pipeline — see **`docs/ci.md`**.
